...
input_size = (224, 224)
labels = ['squat']
anchors = [5.12, 6.03, 5.97, 6.44, 5.66, 5.39, 4.53, 5.87, 4.84, 6.8]
...
def main(anchors, labels = None, model_addr="/sd/model-131336.kmodel", sensor_window=input_size, lcd_rotation=0, sensor_hmirror=False, sensor_vflip=False):
    sensor.reset()
...
if __name__ == "__main__":
    try:
        ...
        main(anchors = anchors, labels=labels, model_addr="/sd/model-131336.kmodel")
    except Exception as e:
